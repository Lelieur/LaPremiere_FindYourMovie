    ...
    axios
      ...
      .then((response) => {
        ...
        filteredMovies.map((eachMovie) => {
          ...
          const newCinemasIds = Array.isArray(copyMovieToEdit.cinemaId)
  ...
  return isLoading ? (
    ...
    <>
                    ...
                    <Nav className="ms-auto">
                      ...
                      {loggedUser && (
                        <NavDropdown title="Editar" id="collapsible-nav-dropdown">
                          <NavDropdown.Item as={Link} to={`/cines/editar/${cinemaId}`}>
                            Editar cine
                          </NavDropdown.Item>
                          <NavDropdown.Divider />
                          <NavDropdown.Item
                ...
                <Col className="details-container" md={{ span: 6 }}>
                    ...
                    <Row>
                      <Col>
                        <Stack direction="horizontal" gap={1}>
                          <Badge className="badge-container-medium" bg="none">
                            Nomal: {cinema.price.regular}€
                          </Badge>
                          <Badge className="badge-container-dark" bg="none">
                            Fin de semana: {cinema.price.weekend}€
                          </Badge>
                          <Badge className="badge-container-ligth" bg="none">
                            Miércoles: {cinema.price.special}€
                          </Badge>
                        </Stack>
                      </Col>
                    </Row>
                      ...
                      <Col>
                        <Stack direction="horizontal" gap={1}>
                          {cinema.services.map((elm) => {
                            return (
                              <Badge bg="none" className="badge-container-ligth" key={elm}>
                                {cinema.services[cinema.services.indexOf(elm)]}
                              </Badge>
                            );
                          })}
                        </Stack>
                  ...
                  <Row className="mb-3">
                    <Row>
                      <Col>
                        <p>
                          <span className="form-section-title">Specs: </span>
                        </p>
                      </Col>
                    </Row>
                    <Row>
                      <Col>
                        ...
                        {cinema.specs.accesibility && (
                          <Image
                            src={IMAGE_PATHS.accesibilityFavicon}
                            className="h-100 me-3"
                            style={{ objectFit: 'contain', maxHeight: '30px' }}
                            fluid
                          />
                    ...
                    <Card className="MovieCard h-100 mx-auto">
                      ...
                      {elm.released ? (
                        <Button
                          ...
                          target="_blank"
                          href={cinema.url}
                          className="styled-button-2 rounded-0 rounded-bottom fw-bold m-0"
                        >
                          Comprar entradas
                        </Button>
                      ) : (
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} backdrop="static" keyboard={false}>
        ...
        <Modal.Body>
          Si continúas no se podrá recuperar el cine seleccionado. ¿Estás seguro de que quieres
          continuar?
        </Modal.Body>
        <Modal.Footer>
